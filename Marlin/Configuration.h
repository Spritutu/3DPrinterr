...
//FIRST TIME: download this lib: https://code.google.com/p/u8glib/wiki/u8glib?tm=6
...
//define the individual endstops here, I only enabled xmin
 ...
 #define ENDSTOPPULLUP_ZMIN
#endif
//connect blue to black with NO switch
